...
The number of total homicides are added up per city_state. The number of unsolved homicides based on disposition is added up per city_state.
...
proportion_unsolved_BMD = df_combined %>% 
  filter(city_state == "Baltimore , MD")

prop_BMD = prop.test(proportion_unsolved_BMD$num_unsolved_hom, proportion_unsolved_BMD$total_num_hom) 
