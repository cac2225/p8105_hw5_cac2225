...
prop_BMD = broom::tidy(prop.test(df_combined_BMD$num_unsolved_hom, df_combined_BMD$total_num_hom))
...
A function is built using prop.test for the unsolved and total parameters to be input for each city_state.
